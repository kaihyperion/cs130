...
document.querySelector('#btn1').onclick = showCat;
document.querySelector('#btn2').onclick = showBird;
document.querySelector('#btn3').onclick = showFish;
document.querySelector('#btn4').onclick = showDog;